...
school_data <- read_excel("MI_school_frame_head_counts.xls")

# Required subsample sizes from Task #1
required_subsample_sizes <- c(15, 28, 41, 25, 37, 39, 43, 43, 43)
...
regions <- c(1:9)
total_students <- c(2893, 5474, 8044, 4855, 14692, 31140, 177421, 178447, 374755)  # N_h
allocated_clusters <- c(1, 1, 1, 1, 1, 1, 1, 1, 1)  # Number of schools sampled per region
required_subsample_sizes <- c(15, 28, 41, 25, 37, 39, 43, 43, 43)  # m_hi
